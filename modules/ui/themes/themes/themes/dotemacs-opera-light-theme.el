;;; dotemacs-opera-light-theme.el --- Opera-Light theme

(require 'dotemacs-themes)

(defgroup dotemacs-opera-light-theme nil
  "Options for dotemacs-themes"
  :group 'dotemacs-themes)

(defcustom dotemacs-opera-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dotemacs-opera-light-theme
  :type 'boolean)

(defcustom dotemacs-opera-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dotemacs-opera-light-theme
  :type 'boolean)

(defcustom dotemacs-opera-light-comment-bg dotemacs-opera-light-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'dotemacs-opera-light-theme
  :type 'boolean)

(defcustom dotemacs-opera-light-padded-modeline dotemacs-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'dotemacs-opera-light-theme
  :type '(or integer boolean))

(defcustom dotemacs-opera-light-region-highlight t
...
(def-dotemacs-theme dotemacs-opera-light
  ...
  ((bg         '("#fafafa" nil       nil ))
   ...
   (selection      dark-blue)
   (builtin        teal)
   (comments       (if dotemacs-opera-light-brighter-comments dark-cyan (dotemacs-lighten base5 0.2)))
   (doc-comments   (dotemacs-lighten (if dotemacs-opera-light-brighter-comments dark-cyan base5) 0.25))
   (constants      magenta)
   (functions      teal)
   (keywords       blue)
   (methods        teal)
   ...
   (-modeline-bright dotemacs-opera-light-brighter-modeline)
   (-modeline-pad
    (when dotemacs-opera-light-padded-modeline
      (if (integerp dotemacs-opera-light-padded-modeline) dotemacs-opera-light-padded-modeline 4)))
  ...
  (
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if dotemacs-opera-light-comment-bg (dotemacs-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; dotemacs-opera-light-theme.el ends here
