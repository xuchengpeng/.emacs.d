...
"
  ...
  (defhydra hydra-workspaces (:color pink
    ...
    "               -- Workspaces --
"
    ("TAB" +workspace/display "Display tab bar" :column "1")
    ...
    ("]" +workspace/switch-right "Next workspace" :column "2")
    ("[" +workspace/switch-left "Previous workspace")
    ("1" +workspace/switch-to-0 "Switch to 1st workspace")
    ("2" +workspace/switch-to-1 "Switch to 2nd workspace")
    ("3" +workspace/switch-to-2 "Switch to 3rd workspace")
    ("4" +workspace/switch-to-3 "Switch to 4th workspace")
    ("5" +workspace/switch-to-4 "Switch to 5th workspace")
    ("6" +workspace/switch-to-5 "Switch to 6th workspace")
    ("7" +workspace/switch-to-6 "Switch to 7th workspace")
    ("0" +workspace/switch-to-final "Switch to final workspace")
