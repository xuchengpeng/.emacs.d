;;; dotemacs-outrun-electric-theme.el --- inspired by VS Code Outrun Electric
(require 'dotemacs-themes)

;;
(defgroup dotemacs-outrun-electric-theme nil
  "Options for dotemacs-themes."
  :group 'dotemacs-themes)

(defcustom dotemacs-outrun-electric-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dotemacs-outrun-electric-theme
  :type 'boolean)

(defcustom dotemacs-outrun-electric-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dotemacs-outrun-electric-theme
  :type 'boolean)

(defcustom dotemacs-outrun-electric-comment-bg dotemacs-outrun-electric-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'dotemacs-outrun-electric-theme
  :type 'boolean)

(defcustom dotemacs-outrun-electric-padded-modeline dotemacs-themes-padded-modeline
...
;;
(def-dotemacs-theme dotemacs-outrun-electric
  ...
  ((bg         '("#0c0a20" "#0c0a20" nil           ))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if dotemacs-outrun-electric-brighter-comments blue grey))
   (doc-comments   teal)
   (constants      violet)
   (functions      cyan)
   (keywords       magenta)
   ...
   (-modeline-bright dotemacs-outrun-electric-brighter-modeline)
   (-modeline-pad
    (when dotemacs-outrun-electric-padded-modeline
      (if (integerp dotemacs-outrun-electric-padded-modeline) dotemacs-outrun-electric-padded-modeline 4)))
  ...
  ((company-tooltip-selection     :background dark-cyan)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if dotemacs-outrun-electric-comment-bg (dotemacs-lighten bg 0.05)))
   (font-lock-doc-face
   ...
   ;; Doom modeline
   (dotemacs-modeline-bar :background magenta)
...
;;; dotemacs-outrun-electric-theme.el ends here
