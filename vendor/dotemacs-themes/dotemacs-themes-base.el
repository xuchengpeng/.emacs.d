;;; dotemacs-themes-base.el -*- lexical-binding: t; -*-

(defvar dotemacs-themes-base-faces
  '(;; --- custom faces -----------------------
    ...
    (diredfl-compressed-file-suffix :foreground (dotemacs-blend orange bg 0.6))
    (diredfl-date-time              :foreground cyan :weight 'light)
    (diredfl-deletion               :foreground red :background (dotemacs-blend red bg 0.2) :weight 'bold)
    (diredfl-deletion-file-name     :foreground red :background (dotemacs-blend red bg 0.2))
    ...
    (diredfl-file-suffix            :foreground (dotemacs-blend fg bg 0.6))
    (diredfl-flag-mark              :foreground yellow :background (dotemacs-blend yellow bg 0.2) :weight 'bold)
    (diredfl-flag-mark-line         :background (dotemacs-blend yellow bg 0.1))
    ...
    ;; twittering-mode
    (twitter-divider  ; custom face in dotemacs
...
(defvar dotemacs-themes-base-vars
...
(provide 'dotemacs-themes-base)
;;; dotemacs-themes-base.el ends here
