;;; dotemacs-solarized-dark-theme.el --- inspired by VS Code Solarized Dark
(require 'dotemacs-themes)

;;
(defgroup dotemacs-solarized-dark-theme nil
  "Options for dotemacs-themes"
  :group 'dotemacs-themes)

(defcustom dotemacs-solarized-dark-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dotemacs-solarized-dark-theme
  :type 'boolean)

(defcustom dotemacs-solarized-dark-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dotemacs-solarized-dark-theme
  :type 'boolean)

(defcustom dotemacs-solarized-dark-comment-bg dotemacs-solarized-dark-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'dotemacs-solarized-dark-theme
  :type 'boolean)

(defcustom dotemacs-solarized-dark-padded-modeline dotemacs-themes-padded-modeline
...
;;
(def-dotemacs-theme dotemacs-solarized-dark
  ...
  ((bg         '("#002b36" nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if dotemacs-solarized-dark-brighter-comments blue base5))
   (doc-comments   teal)
   (constants      violet)
   (functions      blue)
   (keywords       green)
   ...
   (-modeline-bright dotemacs-solarized-dark-brighter-modeline)
   (-modeline-pad
    (when dotemacs-solarized-dark-padded-modeline
      (if (integerp dotemacs-solarized-dark-padded-modeline) dotemacs-solarized-dark-padded-modeline 4)))
  ...
  ((company-tooltip-selection     :background dark-cyan)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if dotemacs-solarized-dark-comment-bg (dotemacs-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; dotemacs-solarized-dark-theme.el ends here
