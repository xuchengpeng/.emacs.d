;;; dotemacs-moonlight-theme.el --- inspired by VS code's Moonlight
(require 'dotemacs-themes)

;;
(defgroup dotemacs-moonlight-theme nil
  "Options for dotemacs-themes"
  :group 'dotemacs-themes)

(defcustom dotemacs-moonlight-padded-modeline dotemacs-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'dotemacs-moonlight-theme
  :type '(choice integer boolean))

;;
(def-dotemacs-theme dotemacs-moonlight
  ...
  ((bg         '("#212337" nil       nil))
   ...
   (builtin        blue)
   (comments       base6)
   (doc-comments   (dotemacs-lighten base5 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       magenta)
   (methods        blue)
   ...
   ;; custom categories
   (modeline-bg     (dotemacs-darken base2 0.1))
   (modeline-bg-alt (dotemacs-darken bg 0.01))
   (modeline-fg     base8)
   (modeline-fg-alt comments)

   (-modeline-pad
    (when dotemacs-moonlight-padded-modeline
      (if (integerp dotemacs-moonlight-padded-modeline) dotemacs-moonlight-padded-modeline 4))))

  ;; --- base faces ------------------------
  (((lazy-highlight &override) :background base4 :foreground fg :distant-foreground fg :bold bold)
   (dotemacs-modeline-buffer-path       :foreground green :weight 'bold)
...
(provide 'dotemacs-moonlight-theme)

;;; dotemacs-moonlight-theme.el ends here
