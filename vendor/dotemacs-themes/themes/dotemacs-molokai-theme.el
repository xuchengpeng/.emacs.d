...
;;
(defgroup dotemacs-molokai-theme nil
...
(defcustom dotemacs-molokai-padded-modeline dotemacs-themes-padded-modeline
...
(def-dotemacs-theme dotemacs-molokai
  ...
  ((lazy-highlight :background violet :foreground base0 :distant-foreground base0 :bold bold)
   ...
   ;; ediff
   (ediff-fine-diff-A :background (dotemacs-blend magenta bg 0.3) :weight 'bold)
...
;;; dotemacs-molokai-theme.el ends here
