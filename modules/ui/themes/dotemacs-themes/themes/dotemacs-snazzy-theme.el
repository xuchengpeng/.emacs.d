;;; dotemacs-snazzy-theme.el --- inspired by Hyper Snazzy
...
;;
(def-dotemacs-theme dotemacs-snazzy
  ...
  ((bg         '("#282a36" "#282a36" nil          )) ;; this is the background for the hl-line, modeline, and minibuffer
   ...
   ;; (vertical-bar   (dotemacs-darken base1 0.1)) ;; no idea what this is
   (vertical-bar (dotemacs-darken base1 0.1)) ;; the bar that separates modeline and
                                          ;; minibuffer?
   ...
   (doc-comments (dotemacs-lighten yellow 0.25)) ;; easy to test with elisp
  ...
  ((mode-line
    :background (dotemacs-darken bg-alt 0.15))
   (mode-line-inactive
    :background (dotemacs-darken bg-alt 0.1)
    :foreground base5)
...
;;; dotemacs-snazzy-theme.el ends here
