;;; dotemacs-tomorrow-day-theme.el -- port of tomorrow theme
;;; Commentary:
;; This file is part of emacs-dotemacs-themes, which provides license
;; information.
;;; Code:

(require 'dotemacs-themes)

(defgroup dotemacs-tomorrow-day-theme nil
  "Options for dotemacs-themes"
  :group 'dotemacs-themes)

(defcustom dotemacs-tomorrow-day-padded-modeline dotemacs-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'dotemacs-tomorrow-day-theme
  :type '(choice integer boolean))

(def-dotemacs-theme dotemacs-tomorrow-day
  ...
  ((bg         '("#ffffff" "white"   "white" ))
   ...
   (dark-cyan  (dotemacs-lighten cyan 0.4))
   ...
   (builtin        blue)
   (comments       grey)
   (doc-comments   (dotemacs-darken grey 0.1))
   (constants      orange)
   (functions      blue)
   (keywords       violet)
   (methods        blue)
   ...
   ;; custom categories
   (modeline-bg     `(,(dotemacs-darken (car bg) 0.1) ,@(cdr base3)))
   (modeline-bg-alt `(,(dotemacs-darken (car bg) 0.14) ,@(cdr base1)))
   (modeline-fg     base8)
   (modeline-fg-alt comments)
   (-modeline-pad
    (when dotemacs-tomorrow-day-padded-modeline
      (if (integerp dotemacs-tomorrow-day-padded-modeline)
          dotemacs-tomorrow-day-padded-modeline
        4))))
...
(provide 'dotemacs-tomorrow-day-theme)
;;; dotemacs-tomorrow-day-theme.el ends here
