...
(defcustom dotemacs-peacock-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dotemacs-peacock-theme
  :type 'boolean)

(defcustom dotemacs-peacock-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dotemacs-peacock-theme
  :type 'boolean)

(defcustom dotemacs-peacock-comment-bg dotemacs-peacock-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'dotemacs-peacock-theme
  :type 'boolean)

(defcustom dotemacs-peacock-padded-modeline dotemacs-themes-padded-modeline
...
(def-dotemacs-theme dotemacs-peacock
  ...
  ((bg         '("#2b2a27" nil       nil            ))
   ...
   (builtin        red)
   (comments       (if dotemacs-peacock-brighter-comments dark-cyan base5)) ;; TODO
   (doc-comments   (dotemacs-lighten (if dotemacs-peacock-brighter-comments dark-cyan base5) 0.25)) ;; TODO
   (constants      red)        ;; done
   ...
   ;; custom categories
   (-modeline-bright dotemacs-peacock-brighter-modeline)
   (-modeline-pad
    (when dotemacs-peacock-padded-modeline
      (if (integerp dotemacs-peacock-padded-modeline) dotemacs-peacock-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if dotemacs-peacock-comment-bg (dotemacs-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; dotemacs-peacock-theme.el ends here
