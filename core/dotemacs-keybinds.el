...
(define-key dotemacs-leader-map "n"  '("Notes" . (keymap)))
(define-key dotemacs-leader-map "nc" '("Capture to node" . org-roam-capture))
(define-key dotemacs-leader-map "nf" '("Find node" . org-roam-node-find))
(define-key dotemacs-leader-map "ng" '("Show graph" . org-roam-graph))
(define-key dotemacs-leader-map "ni" '("Insert node" . org-roam-node-insert))
(define-key dotemacs-leader-map "nl" '("Toggle roam buffer" . org-roam-buffer-toggle))
(define-key dotemacs-leader-map "ns" '("Sync database" . org-roam-db-sync))
(define-key dotemacs-leader-map "ndd" '("Goto date" . org-roam-dailies-goto-date))
(define-key dotemacs-leader-map "ndD" '("Capture date" . org-roam-dailies-capture-date))
(define-key dotemacs-leader-map "ndn" '("Goto next note" . org-roam-dailies-goto-next-note))
(define-key dotemacs-leader-map "ndp" '("Goto previous note" . org-roam-dailies-goto-previous-note))
(define-key dotemacs-leader-map "ndt" '("Goto today" . org-roam-dailies-goto-today))
(define-key dotemacs-leader-map "ndm" '("Goto tomorrow" . org-roam-dailies-goto-tomorrow))
(define-key dotemacs-leader-map "ndy" '("Goto yesterday" . org-roam-dailies-goto-yesterday))
(define-key dotemacs-leader-map "ndT" '("Capture today" . org-roam-dailies-capture-today))
(define-key dotemacs-leader-map "ndM" '("Capture tomorrow" . org-roam-dailies-capture-tomorrow))
(define-key dotemacs-leader-map "ndY" '("Capture yesterday" . org-roam-dailies-capture-yesterday))
