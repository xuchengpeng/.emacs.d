;;; dotemacs-wilmersdorf-theme.el --- inspired by Atom City Lights
(require 'dotemacs-themes)

;;
(defgroup dotemacs-wilmersdorf-theme nil
  "Options for dotemacs-themes"
  :group 'dotemacs-themes)

(defcustom dotemacs-wilmersdorf-padded-modeline dotemacs-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'dotemacs-wilmersdorf-theme
  :type '(choice integer boolean))

;;
(def-dotemacs-theme dotemacs-wilmersdorf
  ...
  ((bg         '("#282b33" nil       nil            ))
   ...
   (builtin        teal)
   (comments       dark-cyan)
   (doc-comments   (dotemacs-lighten dark-cyan 0.25))
   (constants      magenta)
   (functions      teal)
   (keywords       blue)
   (methods        cyan)
   ...
   (-modeline-pad
    (when dotemacs-wilmersdorf-padded-modeline
      (if (integerp dotemacs-wilmersdorf-padded-modeline) dotemacs-wilmersdorf-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (dotemacs-modeline-bar :background highlight)
...
;;; dotemacs-wilmersdorf-theme.el ends here
