...
<https://trevordmiller.com/projects/nova>."
  ...
  ((bg         '("#3c4c55" nil       nil))
   ...
   (fg-alt     (dotemacs-darken fg 0.6)) ;; TODO set correct color
   ...
   (green      "#A8CE93")
   (blue       "#83AFE5")
   (dark-blue  (dotemacs-darken blue 0.7))
   (teal       blue)
   (magenta    (dotemacs-lighten "#b294bb" 0.3)) ; FIXME TODO set correct color
   (violet     "#9A93E1")
   (cyan       "#7FC1CA")
