...
;;
(defgroup dotemacs-Iosvkem-theme nil
  "Options for dotemacs-themes"
  :group 'dotemacs-themes)

(defcustom dotemacs-Iosvkem-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dotemacs-Iosvkem-theme
  :type 'boolean)

(defcustom dotemacs-Iosvkem-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dotemacs-Iosvkem-theme
  :type 'boolean)

(defcustom dotemacs-Iosvkem-comment-bg dotemacs-Iosvkem-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'dotemacs-Iosvkem-theme
  :type 'boolean)

(defcustom dotemacs-Iosvkem-padded-modeline dotemacs-themes-padded-modeline
...
(def-dotemacs-theme dotemacs-Iosvkem
  ...
  ((bg         '("#1b1d1e" "#1b1d1e" nil))
   ...
   (selection      bg-alt)
   (builtin        magenta)
   (comments       (if dotemacs-Iosvkem-brighter-comments dark-cyan base6))
   (doc-comments   (dotemacs-lighten (if dotemacs-Iosvkem-brighter-comments dark-cyan base6) 0.25))
   (constants      green)
   (functions      magenta)
   (keywords       blue)
   (methods        teal)
   ...
   (-modeline-bright dotemacs-Iosvkem-brighter-modeline)
   (-modeline-pad
    (when dotemacs-Iosvkem-padded-modeline
      (if (integerp dotemacs-Iosvkem-padded-modeline) dotemacs-Iosvkem-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if dotemacs-Iosvkem-comment-bg (dotemacs-lighten bg 0.05))
    :slant 'italic)
   ...
   ((outline-4 &override) :foreground (dotemacs-lighten blue 0.2) :weight 'bold)
   ((outline-5 &override) :foreground (dotemacs-lighten magenta 0.2) :weight 'bold)
   ((outline-6 &override) :foreground (dotemacs-lighten dark-cyan 0.2) :weight 'bold)
   ((outline-7 &override) :foreground (dotemacs-lighten blue 0.4) :weight 'bold)
   ((outline-8 &override) :foreground (dotemacs-lighten magenta 0.4) :weight 'bold)
...
;;; dotemacs-Iosvkem-theme.el ends here
