...
(defmacro plist-delete! (plist prop)
  ...
  `(setq ,plist (dotemacs-plist-delete ,plist ,prop)))
    ...
    `(let* ((,plist-sym ,plist)
            ,@(cl-loop for prop in props
                       ...
                       `(,prop
                         (plist-get
                          ,plist-sym
                          ,(dotemacs-keyword-intern (symbol-name prop))))))
       ,@body)))
...
;;;###autoload
(defun dotemacs-plist-get (plist prop &optional nil-value)
...
;;;###autoload
(defun dotemacs-plist-merge (from-plist to-plist)
...
;;;###autoload
(defun dotemacs-plist-delete-nil (plist)
...
;;;###autoload
(defun dotemacs-plist-delete (plist prop)
