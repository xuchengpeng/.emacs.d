;;; dotemacs-palenight-theme.el --- inspired by Material-PaleNight
(require 'dotemacs-themes)

;;
(defgroup dotemacs-palenight-theme nil
  "Options for dotemacs-themes"
  :group 'dotemacs-themes)

(defcustom dotemacs-palenight-padded-modeline dotemacs-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'dotemacs-palenight-theme
  :type '(or integer boolean))

;;
(def-dotemacs-theme dotemacs-palenight
  ...
  ((bg         '("#292D3E" nil       nil))
   ...
   (-modeline-pad
    (when dotemacs-palenight-padded-modeline
      (if (integerp dotemacs-palenight-padded-modeline) dotemacs-palenight-padded-modeline 4))))
...
(provide 'dotemacs-palenight-theme)
